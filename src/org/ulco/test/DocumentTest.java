...
public class DocumentTest extends TestCase {
    ...
    public void testSelect() throws Exception {
        ...
        assertTrue(Select.select(document, new Point(1, 1), 8).size() == 1);
        assertTrue(Select.select(document, new Point(1, 1), 8).firstElement().getID() == c.getID());
    }
    ...
    public void testSelect2() throws Exception {
        ...
        assertTrue(Select.select(document, new Point(1, 1), 8).size() == 2);
    }
    ...
    public void testConstructorGrid() throws Exception {
        ...
        Document document = DocBuild.DoSquare(new Point(0,0), 3, 3, 5);
    ...
    public void testConstructorCircle() throws Exception {
        ...
        assertEquals(DocBuild.DoCircle(new Point(0,0), 4, 3., 4.).getObjectNumber(), 4);
    }
}