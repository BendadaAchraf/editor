...
/**
 * Created by achraf on 27/11/2015.
 */
public class DocBuild {


        public static Document DoSquare(Point origin, int line, int column, double length) {
        ...
        public static Document DoCircle(Point center, int number, double radius, double delta) {
